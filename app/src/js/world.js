var world = {
	...
	init: function () {
		var scene,
            ...
            groundMat = new THREE.MeshLambertMaterial({ color: 0x9000ff, wireframe: false, vertexColors: THREE.FaceColors }),
...
//                zenithGeometry = (app.mobile ? new THREE.PlaneGeometry(120000, 120000, 28, 28) : new THREE.PlaneGeometry(120000, 120000, 16, 16)),
		...
		document.body.appendChild( renderer.domElement );
			...
			var skyTexture = THREE.ImageUtils.loadTexture("/app/data/data-sky.png", null, function () {
				...
				skybox.position.set(three.camera.position.x, 50000, three.camera.position.z);
